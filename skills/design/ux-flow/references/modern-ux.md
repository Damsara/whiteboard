...
- **The nine new WCAG 2.2 criteria are table stakes** — notably Focus Not Obscured, Target Size 24px, a dragging alternative, Consistent Help, Redundant Entry, Accessible Authentication.
...
- **Responsiveness has a hard number** — INP < 200ms at p75; pair with perceived-performance patterns (optimistic UI, layout-matched skeletons, no bare spinner past 1s).
